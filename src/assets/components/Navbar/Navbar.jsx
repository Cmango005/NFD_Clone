...
const Navbar = () => {
    ...
    return (
        <div>
            <div className={`${color ?  "navbar justify-around rounded-3xl p-3 bg-transparent backdrop-blur" : "navbar justify-around border-2 rounded-3xl bg-white p-3 shadow-2xl" }`}>
                ...
                <div className="navbar-end flex items-center gap-4 mr-5">
                    <FaDiscord className="text-violet-400 text-4xl"></FaDiscord>
                    <FaTwitter className="text-violet-400 text-4xl"></FaTwitter>
                </div>
            </div>
        </div>
    );
